...
$route['admin/prerelease/ubah/(:any)'] = 'admin/PreRelease/ubah/$1';
...
$route['admin/sizestock/ubah/(:any)'] = 'admin/SizeStock/ubah/$1';
...
$route['admin/transaksi/reseller'] = 'admin/TransaksiReseller/index';
