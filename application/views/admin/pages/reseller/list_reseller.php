...
<head>
    ...
    <title>Data Akun Reseller</title>
        ...
        <div class="main-wrapper">
            ...
            <div class="main-content">
                <section class="section">
                    <div class="section-header">
                        <h1>Data akun Reseller Chameleon</h1>
                        <div class="section-header-breadcrumb">
                            <div class="breadcrumb-item"><a href="<?= base_url() ?>admin/home">Dashboard</a></div>
                            <div class="breadcrumb-item active"><a href="<?= base_url() ?>admin/akun">Reseller</a></div>
                        </div>
                    </div>
                    <div class="section-body">
                        <h2 class="section-title">Akun Reseller</h2>
                        <p class="section-lead">
                            Berikut data Reseller yang terdaftar di website ini.
                        </p>
                        ...
                        <div class="row">
                            <div class="col-12 col-md-12 col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <button class="btn btn-primary" data-toggle="modal" data-target="#tambahModal" style="margin-bottom:10px"><i class="fa fa-plus"></i> Tambah Reseller</button>
            ...
            <div class="modal fade" tabindex="-1" role="dialog" id="tambahModal">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <form action="<?= base_url() ?>admin/reseller/tambah" method="POST">
            ...
            <div class="modal fade" tabindex="-1" role="dialog" id="updateModal">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Ubah Status Reseller</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <form action="<?= base_url() ?>admin/reseller/ubah" method="POST">
                            <div class="modal-body">
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-lg-6">
