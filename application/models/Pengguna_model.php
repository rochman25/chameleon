...
class Pengguna_model extends MY_Model
{
    ...
    function getCart(){
        $id = $this->session->userdata['user_data']['id'];
        $this->cart->select("produk.nama_produk,produk.id_produk,cart_item.id_cart,detail_cart_item.quantity,detail_cart_item.size,produk.thumbnail_produk,produk.harga_produk,produk.berat_produk,produk.diskon_produk");
